...
router.get("/students/my-courses", authStudent, async (req, res) => {
  const student = req.student;
  try {
    const halfPopulatedStudent = await student
      .populate("courses.course")
      .execPopulate();
    const populatedStudent = await halfPopulatedStudent
      .populate("courses.course.lessons.lesson")
      .execPopulate();
